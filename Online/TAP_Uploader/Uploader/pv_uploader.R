pv_uploader <- function(epoch,vmac) {
  ...
  visit1_time_1 <- as.character(pdb_data[,"visit1_time"])
  visit1_time <<- paste0(gsub(":00$","",visit1_time_1), "am")
  ...
  visit2_time_1 <- as.character(pdb_data[,"visit2_time"])
  visit2_time <<- paste0(gsub(":00$","",visit2_time_1),"am")
  ...
  path_in <- paste0("/srv/shiny-server/resources/Templates/Previsit/pv2_ptp.docx")
  path_in_proxy <- paste0("/srv/shiny-server/resources/Templates/Previsit/pv2_proxy.docx")
  ...
  if (visit_type==3) {
    ...
    visit3_time_1 <- as.character(pdb_data[,"visit3_time"])
    visit3_time <<- paste0(gsub(":00$","",visit3_time_1),"am")
    ...
    # ADD PATHS HERE
    path_in <- paste0("/srv/shiny-server/resources/Templates/Previsit/pv3_ptp.docx")
    path_in_proxy <- paste0("/srv/shiny-server/resources/Templates/Previsit/pv3_proxy.docx")
