MAP_uploader <- function(epoch,vmac) {
  ...
  loc_func <- function(X,loc_day) {
    ...
    loc_proxy <- c(paste0("Day ",X," of ",pronoun_poss," visit will be held at the Vanderbilt Memory and Alzheimer\'s Center, located on 1207 17th Avenue S., Suite 302. Upon arriving at the Vanderbilt Memory & Alzheimer\'s Center, please park in lot 128, to the right of the building, in a spot labeled \"VMAC Participant Parking\". Call 615-347-6937 and a team member will come down to check temperature."),
                   paste0("Day ",X," of ",pronoun_poss," visit will be held at the Vanderbilt University Medical Center, located on 1210 Medical Center Drive (noted with stars on the enclosed maps). Please valet park at the hospital entrance on 1210 Medical Center Drive - valet parking is free. A VMAP team member will meet ",pronoun_obj," inside the hospital lobby."),
  ...
  Print("Starting MAP Uploader Script")
  ...
  path_in <- paste0("/srv/shiny-server/resources/Templates/Follow Up/MAP_",ep,"_template.docx")
  temp <- "/app/Output/previsit_temp.docx"
  path_in_proxy <- paste0("/srv/shiny-server/resources/Templates/Follow Up/MAP_",ep,"_proxy_template.docx")
