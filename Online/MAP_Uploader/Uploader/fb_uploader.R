fb_uploader<<- function(epochh,vmac) {
  ...
  countss<- counts+3
  patterns<- rep(c('stripe','stripe','crosshatch','circle'),6)
  ...
  ptp_path<<- paste0("/srv/shiny-server/resources/Templates/Feedback/fb_letter_template_",epoch,".docx")
  phys_path<<- paste0("/srv/shiny-server/resources/Templates/Feedback/physician_temp_",epoch,".docx")
  ...
  output<- paste0("/app/Output/feedback_letter_MAP_",input,"_",epoch,".docx")
