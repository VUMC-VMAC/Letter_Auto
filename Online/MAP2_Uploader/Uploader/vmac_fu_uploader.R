vmac_fu_uploader <- function(vmac_id) {
  ...
  if (exists("response")==FALSE) {print("No Updates")} else {
    ...
    #for (i in 1:3) {
    i<-1
    vmac_id <- vmac[[i]][["vmac_id"]] # NEED to put ID selector here
    ...
    screen_conv <- c("81"="Sope Adeleye", "33"="Maddy Berkowitz-Cerasano", "61"="Sameeksha Malhotra","64"="Natalie Givens", "32"="Marilyn Steinbach", "62" ="Shelbie Wenner", "31"="Jordan Rahm","63"="Hannah Gavins","35"="Malek Jacobs","3"="Samantha Brown","34"="Emily Bradford")
    initial_conv <- c("81"="SA","33"="MBC","61"="SHM","64"="NRG","32"="MS","62"="SW","31"="JR","63"="HG","35"="MJ","30"="SB","34"="EB")
