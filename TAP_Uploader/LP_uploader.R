LP_uploader <- function(epoch,vmac) {
  ...
  output <- paste0("C:/Users/sweelyb/Documents/resources/Output/TAP_",ep,"_",input,"_LP_letter.docx")
  path_in <- paste0("C:/Users/sweelyb/Documents/resources/Templates/Lumbar Puncture/TAP_LP_template.docx")
