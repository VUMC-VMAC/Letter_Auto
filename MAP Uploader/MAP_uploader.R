MAP_uploader <- function(epoch,map) {
  ...
  ii <- which(pdb_datas["map_id"]==as.integer(map))
  ...
  if (e > 2) {
    ...
    partner <<- paste0("Study Partner Packet. We have included/mailed a packet of material for/to your study partner, ",proxy_first_name,", which we ask that ",proxy_pronoun," complete prior to your visit.")
  ...
  output <- paste0("C:/Users/sweelyb/Documents/resources/Output/MAP_",ep,"_",input,"_ptp_letter.docx")
  ...
  if (is.na(proxy_first_name)==FALSE) {
    output_proxy <- paste0("C:/Users/sweelyb/Documents/resources/Output/MAP_",ep,"_",input,"_proxy_letter.docx")
