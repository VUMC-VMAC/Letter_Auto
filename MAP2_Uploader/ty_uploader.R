ty_uploader <- function(epoch,vmac) {
  ...
  if (e==0){
    ...
    elig_out <- el_data[ii,"elig_outcome"]; if (is.na(elig_out)) {elig_out <- "Yes"}
    enroll_stat <- el_data[ii,"enroll_visit_sched"]; if (is.na(enroll_stat)) {enroll_stat <- "No"}
    
    if (elig_out == "No") {
      elig <<- "Even though it was determined that you are not eligible to participate in the Vanderbilt Memory & Aging Project, we appreciate you donating your time to our research efforts. Thank you for your contribution to this important project. Our efforts would not be possible without your generous help and time."
    } else {
      if (enroll_stat == "No") {
        elig <<- "You are now part of a valuable research study that will help middle aged and older adults at risk for memory loss. Your participation will help answer important questions about how heart health relates to brain health. We will be in touch with you by phone to schedule your enrollment visit. Thank you for your contribution to this important project. Our efforts would not be possible without your generous help."
      } else {
        elig <<- "You are now part of a valuable research study that will help middle aged and older adults at risk for memory loss. Your participation will help answer important questions about how heart health relates to brain health. We look forward to seeing you at your upcoming enrollment visit on `enroll_date`. Thank you for your contribution to this important project. Our efforts would not be possible without your generous help."
      }
    }
